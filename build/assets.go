...
func addVideoToProject(projectFile, videoFile, withText string) error {
	...
	err = addAssetToSpine(&fcpxml, existingAssetID, absVideoPath, baseName, duration, withText)
	if err != nil {
		return err
	}
...
func addAssetToSpine(fcpxml *fcp.FCPXML, assetID, absVideoPath, baseName, duration, withText string) error {
